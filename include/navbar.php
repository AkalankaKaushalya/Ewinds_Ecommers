                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Welcome to E Winds Store</a>
                            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                                    <!-- <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="index.php" style="font-size: 45px;" aria-label="Electro"><span style="font-size: 55px; font-weight: 700; color: rgb(252, 140, 3); padding-right: 15px;">E</span></span >Winds </a> -->

                                    <img class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center"  src="assets/logo.jpg" style="width: 100px; height: 100px;">
                                    <!-- Logo -->
                                            ...
                                            <div class="u-header-sidebar__footer-offset pb-0">
                                                ...
                                                <div class="js-scrollbar u-sidebar__body">
                                                    <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                        <!-- Logo -->
                                                        <a class="d-flex ml-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-vertical" href="index.php" aria-label="ewinds">
                                                             <img class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center"  src="assets/logo.jpg" style="width: 100px; height: 100px;">
                                                            <!-- <svg version="1.1" x="0px" y="0px" width="175.748px" height="42.52px" viewBox="0 0 175.748 42.52" enable-background="new 0 0 175.748 42.52" style="margin-bottom: 0;">
                                                                <ellipse class="ellipse-bg" fill-rule="evenodd" clip-rule="evenodd" fill="#FDD700" cx="170.05" cy="36.341" rx="5.32" ry="5.367"></ellipse>
                                                                <path fill-rule="evenodd" clip-rule="evenodd" fill="#333E48" d="M30.514,0.71c-0.034,0.003-0.066,0.008-0.056,0.056
                                                        ...
                                                        <ul id="headerSidebarList" class="u-header-collapse__nav">
                                                            ...
                                                            <!-- Shop Pages -->
                                                            <li class="nav-item u-header__nav-item">
                                                                <a class="nav-link u-header__nav-link" href="shop.php">Shop</a>
                                                            </li>
                                                            <!-- End Shop Pages -->
                                                                    ...
                                                                    <ul id="headerSidebarBlogMenu" class="u-header-collapse__nav-list">
                                                                        <?php
                                                                           ...
                                                                           $vtype = '';
                                                                            ...
                                                                            {
                                                                               echo $vtype .='<li> <a href="'.$base_url.'shop.php?cid='.$vtype_row['id'].'"  class="u-header-collapse__submenu-nav-link">'.$vtype_row['name'].'</a> </li>';
                                                                            } 
                                                                         ?>
                                                                        <!-- <li>
                                                                            <a class="u-header-collapse__submenu-nav-link" href="#">E-Bike</a>
                                                                        </li>
                                                                        <li>
                                                                            <a class="u-header-collapse__submenu-nav-link" href="#">Mobile phone Accessories</a>
                                                                        </li> -->
                                                                    </ul>
                                                                </div>
                                                            </li>
                                    ...
                                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                        <ul class="navbar-nav u-header__navbar-nav">
                                            ...
                                            <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                                <a id="blogMegaMenu" class="nav-link u-header__nav-link u-header__nav-link-toggle" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="blogSubMenu">Product Categories</a>
                                                <ul id="blogSubMenu" class="hs-sub-menu u-header__sub-menu" aria-labelledby="blogMegaMenu" style="min-width: 230px;">
                                                    ...
                                                    <?php
                                                       ...
                                                       $vtype = '';
                                                        ...
                                                        while($vtype_row = mysqli_fetch_assoc($vtype_res))
                                                        {
                                                           echo $vtype .='<li> <a href="'.$base_url.'shop.php?cid='.$vtype_row['id'].'"  class="nav-link u-header__sub-menu-nav-link">'.$vtype_row['name'].'</a> </li>';
                                                        } 
                                                     ?>
                                                    <!-- <li><a class="nav-link u-header__sub-menu-nav-link" href="#">E-Bike</a></li>
                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Mobile phone Accessories</a></li>   -->
                                                </ul>
                                            </li>
                                            <!-- End Blog -->
                            ...
                            <div class="d-none d-xl-block col-md-auto">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        <div class="phone">
                                            <strong>Support</strong> <a href="tel:+447914114923" class="text-gray-90">+44 7914 114923</a>
                                        </div>
                                        <div class="email">
                                            E-mail: <a href="mailto:ewinds.ukltd@gmail.com?subject=Help Need" class="text-gray-90">ewinds.ukltd@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
